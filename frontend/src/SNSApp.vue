            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="champions"
                        to="/championHistories/champions"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '전적', 
                description: '게임 아이디의 전적에 대한 정보', 
                key: 'records', 
                route: '/recordSearches/records',
                ImageUrl: '',
            },
            { 
                title: '챔피언', 
                description: '챔피언에 대한 상세 기록', 
                key: 'champions', 
                route: '/championHistories/champions',
                ImageUrl: '',
            },
