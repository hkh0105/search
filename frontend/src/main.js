...
pluralCaseList.push( {plural: "recordSearches/records", pascal: "RecordSearchRecord"} )

pluralCaseList.push( {plural: "championHistories/champions", pascal: "ChampionHistoryChampion"} )
